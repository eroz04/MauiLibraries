...
class AccessTokenImpl implements AccessToken {
    ...
    public AccessTokenImpl(Date expires, String[] permissions, String[] declinedPermissions, String[] expiredPermissions, String token, Date lastRefresh, String applicationId, String userId, Date dataAccessExpirationTime, String graphDomain) {
